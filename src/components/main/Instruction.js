...
import video from '../../../src/assets/video/app.webm';
  ...
  constructor(props) {
    ...
    <div className='main'>
      ...
      <h1>First Time For Everything</h1>
            <p>
            First acquire a blockchain wallet from a wallet provider
            we recommand Metamask <br></br>
            Metamask will turn your browser in to a blockchain client, 
            this will allow interaction with the blockchain network
            </p>
            <a href='https://metamask.io/' className='button' >Get wallet</a>
        </div>
        <div className='img1'>
        ...
        <div className='information'>
            ...
            <p>see demonstartion on how smart contacts automatically execute </p>
        </div>
        <div className='img2a'>
